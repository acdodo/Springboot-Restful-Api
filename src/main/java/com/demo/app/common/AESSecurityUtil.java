...
public class AESSecurityUtil {
    ...
    private static final String pkey="VxDSAWQKiTvt9MNPtMAXdV=+";
    /** 加密/解密算法/工作模式/填充方法 */
//    public static final String CIPHER_ALGORITHM = "AES/ECB/NoPadding";
    ...
    public static String decrypt(String data) throws Exception{
        return decrypt(Base64.decodeBase64(data), Base64.decodeBase64(pkey));
    }
...
//        System.out.println(cipher.doFinal(data));
    ...
    public static String encrypt(String data) throws Exception{
        ...
        byte[] keyBytes = Base64.decodeBase64(pkey);
        return Base64.encodeBase64String(encrypt(dataBytes, keyBytes)).replace("\r\n", "");
    }
...
////        String key = "VxDSAWQKiTvt9MNPtMAXdV=+";
//        String jimm="21grid.com";
//        
//        String mw = AESSecurityUtil.encrypt(jimm);
//        System.out.println(mw);
//        String jm = AESSecurityUtil.decrypt(mw);
